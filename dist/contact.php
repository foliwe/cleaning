...
<div class="hidden md:block bg-stone-100 py-5">
  ...
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-5 flex items-end justify-start relative">
      ...
      <div class="w-full bg-white relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <a class="text-teal-500 leading-relaxed">info@ryanservicesltd.co.uk</a>
    ...
    <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      <h2 class="text-gray-900 text-lg mb-1 font-medium title-font"></h2>
      <p class="leading-relaxed mb-5 text-gray-600">Fill out the form below for quotes or call us on <span class="font-bold text-xl text-teal-500"> +442088541211</span> </p>
       <?php if (!empty($errors)): ?>
            <div class="errors">
